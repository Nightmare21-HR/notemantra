        ...
        <>
            <style>{`
                ...
                *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
                ...
                .nm-auth-root {
                    ...
                    background-image:
                        radial-gradient(ellipse 70% 50% at 50% 0%, rgba(120, 60, 220, 0.12) 0%, transparent 60%),
                        radial-gradient(ellipse 40% 40% at 15% 85%, rgba(56, 100, 255, 0.07) 0%, transparent 60%);
                    padding: 20px;
                }
                ...
                .nm-auth-switch-link:hover { color: #c4b5fd; }
            `}</style>
            ...
            <div className="nm-auth-root">
                <div className="nm-auth-card">
                    ...
                    <div className="nm-auth-heading">Create your account</div>
                    <div className="nm-auth-sub">Join the intelligent study revolution</div>

                    <div className="nm-auth-perks">
                        <div className="nm-auth-perk"><span className="nm-auth-perk-dot"></span>AI-powered notes</div>
                        <div className="nm-auth-perk"><span className="nm-auth-perk-dot"></span>Topic mapping</div>
                        <div className="nm-auth-perk"><span className="nm-auth-perk-dot"></span>Master guides</div>
                    </div>
                    ...
                    <form onSubmit={handleSubmit}>
                        ...
                        <button type="submit" className="nm-auth-btn" disabled={loading}>
                            {loading ? <><span className="nm-spinner"></span>Creating account...</> : 'Create Account'}
                        </button>
                    </form>
